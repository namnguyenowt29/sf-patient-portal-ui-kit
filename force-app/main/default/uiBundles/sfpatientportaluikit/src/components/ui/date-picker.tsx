  ...
  return (
    <PopoverTrigger asChild>
      <Button
        ...
        data-empty={!date}
        className={cn("data-[empty=true]:text-muted-foreground w-70 justify-start text-left font-normal", className)}
        {...props}
      >
        {children ?? (
          <>
...
function DatePickerContent({ className, ...props }: React.ComponentProps<typeof PopoverContent>) {
  return <PopoverContent data-slot="date-picker-content" className={cn("w-auto p-0", className)} {...props} />;
}
